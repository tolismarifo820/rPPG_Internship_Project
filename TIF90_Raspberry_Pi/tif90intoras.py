...
# DEVICE TOGGLE
# ==============================================================================
# Set to 1 to run on Laptop (cv2.VideoCapture)
# Set to 0 to run on Raspberry Pi (Picamera2)
RUN_ON_LAPTOP = 1
...
if RUN_ON_LAPTOP:
    ...
    try:
        ...
        pass # Will fail later if set to 0 on a non-Pi machine

    # Robust MediaPipe FaceMesh module resolution for Pi
    try:
...
hr_low, hr_high = 0.7, 3.0   # Restricted to 42 - 180 BPM
...
alpha_bgr = 50.0            
alpha_yiq = 50.0            
minFrequency = 0.7          # Restricted to 42 BPM
maxFrequency = 3.0          # Restricted to 180 BPM
